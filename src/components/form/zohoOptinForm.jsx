...
const ZohoOptinForm = () => {
  ...
  return (
    <div
      id="sf3zf872ce0486e1c60e8b6e94f2b182c0fafe686e016e87ed76766d4298099db22d"
    ...
    >
        ...
        <div className="quick_form_19_css" name="SIGNUP_BODY">
          <div>
                    ...
                    <tr>
                      <td width="10%">
                        <img
                          ...
                          src="https://vkqvt-zgpvh.maillist-manage.net/images/challangeiconenable.jpg"
                          align="absmiddle"
                          alt="Success Icon"
                        />
                      </td>
            ...
            <form
              ...
              action="https://vkqvt-zgpvh.maillist-manage.net/weboptin.zc"
              target="_zcSignup"
            ...
            >
              ...
              <p
                className={`text-[14px] mb-[10px] text-[#375370] ${isBlogPostPage ? " " : "hidden"}`}
              >
                Read about our privacy policy
              </p>
              <p
                className={`text-[14px] mb-[10px] leading-[20px] text-[#375370] ${isHomePage ? " " : "hidden"}`}
              >
              ...
              <input
                ...
                id="zcld"
                name="zcld"
                value="1e2e7c7346941391"
              />
              <input
                type="hidden"
                id="zctd"
                name="zctd"
                value="1e2e7c73462bdbe1"
              />
              <input type="hidden" id="document_domain" value="" />
              <input
                type="hidden"
                id="zc_Url"
                value="vkqvt-zgpvh.maillist-manage.net"
              />
              ...
              <input
                ...
                id="zc_formIx"
                name="zc_formIx"
                value="3zf872ce0486e1c60e8b6e94f2b182c0fafe686e016e87ed76766d4298099db22d"
              />
      ...
      <img
        src="https://vkqvt-zgpvh.maillist-manage.net/images/spacer.gif"
        className="hidden"
        id="refImage"
        onLoad={() => {
          window.referenceSetter &&
      ...
      >
        ...
        >
          <img
            src="https://vkqvt-zgpvh.maillist-manage.net/images/videoclose.png"
            alt="Close"
          />
        </span>
