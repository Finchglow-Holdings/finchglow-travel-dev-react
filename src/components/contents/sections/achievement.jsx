...
const AchievementsSection = () => {
  ...
  return (
    <section className="relative flex flex-col justify-center items-center bg-[#03182E] bg-blend-soft-light bg-no-repeat bg-cover bg-center py-[70px] w-full h-auto overflow-hidden"
      ...
      <div className="static w-full flex flex-col justify-center items-center 2xl:w-[1280px] px-[15px] py-[50px] at500:pl-[80px] at500:pr-[40px] my-0 mx-auto">
        <div className="flex flex-col lg:flex-row justify-between items-center w-full gap-[30px]">
            ...
            <div className="relative flex flex-col items-start w-full">
                <span data-aos="fade-up" className="txt2 text-[#0260EE] capitalize mb-[10px]">
                    Key Achievements
                </span>
                <h3 data-aos="fade-up" className="text-[#FFFFFF] !text-[30px] lg:w-[452px] mb-[10px]">
                    We’ve mastered connecting our clients with the rest of the world and perfected 
                    providing exceptional service and travel experiences.
                </h3>
                <p data-aos="fade-up" className="leading-[24px] text-[16px] text-[#E6EFFD] lg:w-[452px] mb-[20px]">
                    Since we launched in June 2006, we have expanded from one branch to nine branches across Nigeria,
                    won over 20 industry awards, and serviced over 20,000 clients. We are dedicated to offering the best
                    possible service across all our touch points.
                </p>
                <a data-aos="fade-up" href="#" className="arrow hover:!text-[#3580F1]">Learn more
                    <GoArrowUpRight className="fa-solid fa-arrow-right text-[#3580F1] hover:text-[#3580F1]" />
                </a>
            </div>
            ...
            <div className="grid at594:grid-cols-2 gap-y-[100px] items-start gap-x-[32px] w-full">
                ...
                <div className="flex flex-col justify-start items-start gap-[8px] w-full">
                    <span data-aos="fade-up">
                        <img src={icon1} className='w-[46px] h-auto object-cover' alt="dollor sign" />
                    </span>
                ...
                <div className="flex flex-col justify-center gap-[8px] items-start w-full">
                    <span data-aos="fade-up">
                        <img src={icon2} className='w-[46px] h-auto object-cover' alt="dollor sign" />
                    </span>
                ...
                <div className="flex flex-col justify-center gap-[8px] items-start w-full">
                    <span data-aos="fade-up">
                        <img src={icon3} className='w-[46px] h-auto object-cover' alt="dollor sign" />
                    </span>
                ...
                <div className="flex flex-col justify-center gap-[8px] items-start w-full">
                    <span data-aos="fade-up">
                        <img src={icon4} className='w-[46px] h-auto object-cover' alt="dollor sign" />
                    </span>
