  ...
  return (
    <div className="relative flex flex-col justify-center items-center w-full h-auto gap-[28.44px]">
      <div className="relative flex flex-col justify-center items-center w-full h-auto gap-[8px]">
        <h3 className="text-[#05284C] text-center"dangerouslySetInnerHTML={{ __html: props.subTitle }}></h3>
        <p className="text-[#375370] text-[16px] leading-[24px] text-center lg:w-[816px]">
            {props.details}
        </p>
      </div>
    </div>
