...
function header() {
  ...
  return (
    <div
      className="relative flex flex-col  items-baseline bg-no-repeat bg-cover bg-center h-screen py-[70px] w-full overflow-hidden"
    ...
    >
      ...
      <div className=" absolute bottom-[-154px]  flex flex-col justify-center items-center w-full 2xl:w-[1280px] px-[15px] at500:px-[40px] my-0 mx-auto h-full">
        ...
        <div className="relative w-full z-[888]  cursor-pointer ">
          <a href="#middle">
            <GoArrowDown className="text-[#FFFFFF] hover:text-[#3580F1] absolute right-0 bottom-0  w-[57.82px] h-[57.82px] object-cover cursor-pointer" />
          </a>
        </div>
      </div>
    </div>
