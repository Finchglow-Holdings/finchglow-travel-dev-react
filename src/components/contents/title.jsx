    ...
    <section className="relative bg-[#EEF5FF] flex flex-col justify-center items-center w-full overflow-hidden">
      <div className="static w-full flex flex-col justify-center items-center 2xl:w-[1280px] px-[15px] py-[60px] at500:px-[64px] md:pr-[64px] md:pl-[94px] my-0 mx-auto">
        <div className="flex flex-col lg:flex-row justify-between w-full gap-[30px] lg:gap-[168px]">
          <div className="relative flex flex-col justify-center items-start w-full lg:w-[513px] text-left gap-[17px]">
            <span data-aos="fade-up" className="txt2 text-[#0260EE]">
              {props.title}
            </span>
            <h3
              data-aos="fade-up"
              className={`text-[#101828]  ${isBlogPage ? "lg:!w-[513px]" : isContactPage ? "lg:!w-[396px]" : "lg:w-[595px]"}`}
            >
              {props.subTitle}
            </h3>
            <span
              data-aos="fade-up"
              className={`text-[#697E94] txt2 !leading-[26px] md:w-[407px]  ${isBlogPostPage ? "block" : "hidden"}`}
            >
              {props.subTitle2}
            </span>
          </div>

          <div className="relative flex flex-col justify-center items-end lg:px-[30px] py-0 w-full h-auto">
