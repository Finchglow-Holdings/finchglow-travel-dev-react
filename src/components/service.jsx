        ...
        <div className="static w-full flex flex-col justify-center items-center  2xl:w-[1280px] px-[15px] py-[55px] lg:py-[200px]  at500:px-[64px] md:pr-[64px] md:pl-[94px] my-0 mx-auto">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center  w-full h-auto ">
            ...
            <div className="relative lg:bottom-[-78px] flex justify-start items-start w-full h-auto mb-[30px] lg:mb-0 ">
                <img src={image1} className="w-full h-[300px] lg:w-[559px] lg:h-[656px] object-cover" alt="" />
            </div>
            ...
            <div className="relative flex flex-col justify-center items-center w-full h-auto text-left ">
              ...
              <div className="relative flex flex-col justify-center items-start gap-[17px] w-full lg:w-[446px] h-auto text-left ">
                <span data-aos="fade-up"  className="relative w-full h-auto mb-[10px]">
                  <img src={icons1} className="h-[64px] w-[64px] object-cover" alt="" />
                </span>
                <div className="flex flex-col justify-center items-start gap-[16px] text-left w-full silver:w-[446px]">
                  ...
                  <span data-aos="fade-up"  className="txt2 text-[#667085] text-left w-full silver:w-[358px]">
                      Unlock Your Revenue Potential: Join Our Affiliate Program Today!
                  </span>
                </div>
                <span data-aos="fade-up" className="txt2 text-[#667085] text-left w-full silver:w-[446px]">
                    Are you a travel agency looking to increase revenue and offer your clients unbeatable deals?
                    Look no further! Join our esteemed affiliate program, Trade Partner Plus, and say hello to a
                    tomorrow of limitless possibilities.
                </span>
                <a data-aos="fade-up" href="#" className="arrow !text-[#0260EE]">
                   Why Choose Us
                  <FaArrowRight />
                </a>
              </div>
        ...
        <div className="static w-full flex flex-col justify-center items-center  2xl:w-[1280px] px-[15px] py-[55px] lg:pt-[300px] lg:pb-[200px]  at500:px-[64px] md:pr-[64px] md:pl-[94px] my-0 mx-auto">
          ...
          <div className="flex flex-col-reverse lg:flex-row justify-between items-center  w-full h-auto ">
            ...
            <div className="relative flex flex-col justify-center items-start gap-[17px] w-full h-auto text-left ">
              <div data-aos="fade-up" data-aos-duration="3000" data-aos-anchor-placement="top-bottom" className="relative w-full h-auto mb-[10px]">
                <span className="relative h-[64px] w-[64px] flex justify-center items-center rounded-[50%] bg-[#FAC2C3]">
                    <img src={icons2} className="absolute h-[20px] w-[20px] object-cover" alt="" />
                </span>
              </div>
              <div className="flex flex-col justify-center items-start gap-[16px] text-left w-full silver:w-[446px]">
                <h3 data-aos="fade-up" data-aos-duration="3000" data-aos-anchor-placement="top-bottom" className="text-[#05284C]">
                    Corporate Travel Management
                </h3>
                <span data-aos="fade-up" data-aos-duration="3000" data-aos-anchor-placement="top-bottom" className="txt2 text-[#667085] text-left w-full silver:w-[318px]">
                    Transform Your Corporate Travel Experience with Us!
                </span>
              </div>
              <span data-aos="fade-up" data-aos-duration="3000" data-aos-anchor-placement="top-bottom" className="txt2 text-[#667085] text-left w-full silver:w-[422px]">
                Every decision matters in today's fast-paced business landscape, especially managing 
                your company's travel needs. That's where we come in – your dedicated travel partner 
            ...
            <div className="relative lg:bottom-[-85px] flex justify-end items-end w-full h-auto mb-[30px] lg:mb-0">
              <img src={image2} className="w-full h-auto lg:w-[457px] lg:h-[589px] object-cover" alt="" />
            </div>                        
          </div> 
        ...
        <div className="static w-full flex flex-col justify-center items-center  2xl:w-[1280px] px-[15px] at500:px-[64px] py-[55px] lg:pt-[200px] lg:pb-0 md:pl-[94px] md:pr-[64px] lg:pl-0 my-0 mx-auto">
          <div className="flex flex-col lg:flex-row justify-between items-center  w-full">
            ...
            <div className="relative w-full h-auto mb-[30px] lg:mb-0">
              <img src={image3} className="w-full h-auto lg:w-[623px] lg:h-[656px] object-cover" alt="" />
            </div>

            <div className="relative flex flex-col justify-center items-center gap-[17px] w-full h-auto text-left ">
              <div className="relative flex flex-col justify-center items-start gap-[17px] w-full lg:w-[446px] h-auto text-left">
                <span data-aos="fade-up" data-aos-duration="3000" data-aos-anchor-placement="top-bottom" className="relative w-full h-auto mb-[10px]">
                  <img src={icons3} className="h-[64px] w-[64px] object-cover" alt="" />
                </span>
                <div className="flex flex-col justify-center items-start gap-[16px] text-left w-full silver:w-[446px]">
                  <h3 data-aos="fade-up" data-aos-duration="3000" data-aos-anchor-placement="top-bottom" className="text-[#05284C]">
                    Bespoke Travel
                ...
                <span data-aos="fade-up" data-aos-duration="3000" data-aos-anchor-placement="top-bottom" className="txt2 text-[#667085] text-left w-full silver:w-[422px]">
                  It's time to enter a world of remarkable travel experiences and seamless 
                  journeys. At Finchglow Travels, we've crafted several possibilities that cater 
                  to your individual or group needs, whether leisurely getaways or strategic business 
                  ventures.
                </span>
                <a data-aos="fade-up" href="#" className="arrow !text-[#0260EE]">
                  Why Choose Us
      ...
      <section className="relative bg-[#EEF5FF] flex flex-col justify-center items-center w-full h-auto lg:h-[691px] overflow-hidden z-[22] lg:overflow-visible">
        <div className="static w-full flex flex-col justify-center items-center  2xl:w-[1280px] px-[15px] py-[55px] lg:pb-[70px] at500:px-[64px] md:pr-[64px] md:pl-[94px] my-0 mx-auto">
          <div className="flex flex-col-reverse lg:flex-row justify-between items-center  w-full h-auto my-[50] lg:mt-0 lg:mb-[100px]">
            ...
            <div className="relative flex flex-col justify-center items-start gap-[17px] w-full h-auto text-left ">
              <span data-aos="fade-up" data-aos-duration="3000" data-aos-anchor-placement="top-bottom" className="relative silver:w-[446px] h-auto mb-[10px]">
                <img src={icons4} className="h-[64px] w-[64px] object-cover" alt="" />
              </span>
              <div className="flex flex-col justify-center items-start gap-[16px] text-left w-full silver:w-[446px]">
                <h3 data-aos="fade-up" data-aos-duration="3000" data-aos-anchor-placement="top-bottom" className="text-[#05284C]">
                  Ancillary Services
                </h3>
                <span data-aos="fade-up" data-aos-duration="3000" data-aos-anchor-placement="top-bottom" className="txt2 text-[#667085] text-left w-full ">
                  Enrich Your Travels with Our Comprehensive Ancillary Services!
                </span>
              </div>
              <span data-aos="fade-up" data-aos-duration="3000" data-aos-anchor-placement="top-bottom" className="txt2 text-[#667085] text-left w-full silver:w-[422px]">
                Travelling shouldn’t feel like a chore, just one more thing to cross off your to-do list. 
                It is an experience, and we’re here to make every aspect of that experience satisfying and unforgettable. 
                Introducing our premium range of ancillary services – the perfect companions to enrich your travel experience 
                like never before.
              </span>
            ...
            <div className="relative flex justify-end items-end w-full h-auto mb-[30px] lg:mb-0">
              <img src={image4} className="w-full h-auto lg:w-[538px] lg:h-[689px] object-cover" alt="" />
            </div> 
