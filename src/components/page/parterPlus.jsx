          ...
          <div className="flex flex-col-reverse lg:flex-row justify-center items-center  w-full h-auto lg:h-[561px]">
            <div className="relative flex justify-start items-start w-full h-auto text-left">
              <div className="flex flex-col justify-center items-start gap-[17.78px] text-left lg:w-[392px]">
                ...
                >
                  Our PartnerPlus Connect webinar is open to all travel industry
                  stakeholders. However, to get the full experience and enjoy
                  access to our complete library or past episodes, you’ll need
                  to sign up for our affiliate program, Trade PartnerPlus.
                </p>
                <p
                  data-aos="fade-up"
                  className=" text-[16px] leading-[24px] text-[#375370]"
                >
                  You’ll also enjoy other benefits like access to our extensive
                  network of suppliers, marketing support and resources,
                  unbelievable discounts, ticket issuance on GDS platforms,  and
                  hardware and software assistance from our world-class global
                  support centre
                </p>
              </div>
            </div>
