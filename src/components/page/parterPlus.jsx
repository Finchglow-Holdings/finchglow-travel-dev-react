...
function PartnerPlusConnect() {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full">
      ...
      <section
        className="relative flex flex-col justify-center items-center  bg-[#03182E]  bg-blend-soft-light bg-no-repeat bg-cover bg-center md:h-[497px] w-full h-auto overflow-hidden"
      ...
      >
        <div className="static w-full flex flex-col justify-center items-center 2xl:w-[1280px] px-[15px] py-[30px] at500:px-[70px] my-0 mx-auto">
          <div className="flex flex-col lg:flex-row justify-center items-start gap-[45px] w-full">
            ...
            >
              From practical tips for business development to in-depth analyses
              of market trends, PartnerPlus Connect equips participants with the
              knowledge and insights needed to stay ahead of the curve.
            </span>
            <span
              data-aos="fade-up"
      ...
      <section className="relative flex flex-col justify-center items-center bg-[#FFFFFF] w-full h-auto overflow-hidden">
        <div className="static w-full flex flex-col justify-center gap-[30px] items-center 2xl:w-[1280px] px-[15px] py-[70px] at500:px-[80px] my-0 mx-auto">
          <div className="flex flex-col gap-[30px] md:w-[89%] px-[20px]">
            ...
            <div className="flex flex-col lg:flex-row justify-start items-start gap-[58px] w-full ">
              <ul className="flex flex-col justify-center items-start space-y-2 txt5 text-[#506982] list-disc w-[490.5px]">
                <li>
                  Find inspiration or expert guidance on becoming a travel agent
                  or signing up as a Trade Partner.
                </li>
                <li>Learn new techniques to improve their work efficiency.</li>
                <li>Brush up on past knowledge about the travel industry.</li>
              </ul>

              <ul className="flex flex-col justify-center items-start space-y-2 txt5 text-[#506982] list-disc w-[490.5px]">
                <li>
                  Expand their horizons with invaluable insights and strategies
                  for success.
                </li>
                <li>
      ...
      <section className="relative flex flex-col justify-center items-center bg-[#EEF8FF]  w-full h-auto  overflow-hidden">
        <div className="static w-full flex flex-col justify-center gap-[30px] items-center 2xl:w-[1280px] px-[15px] py-[70px] at500:px-[40px] my-0 mx-auto">
          <EpisodesSlide/>
        </div>
      </section>
      ...
      <section className="relative bg-custom2-gradient flex flex-col justify-center items-center w-full h-auto lg:h-[418px] overflow-hidden z-[3] lg:overflow-visible">
        <div className="static w-[90%] flex flex-col justify-center items-center 2xl:w-[1280px] px-[15px] py-[55px] at500:px-[40px]  md:px-[80px] my-0 mx-auto">
          <div className="relative lg:bottom-[60px] flex bg-[#05284C] flex-col-reverse lg:flex-row justify-center items-center w-full h-auto lg:h-[426.67px] rounded-[21.33px] pt-[40px] pb-[10px] px-[60px] overflow-hidden">
                ...
                <div className="flex flex-col justify-center items-start gap-[35.56px] text-left w-full">
                  <div className="flex flex-col justify-center items-start gap-[17.78px] text-left lg:w-[426.67px]">
                    ...
                    >
                      ...
                      business or you already have a career in the industry, be
      ...
      <section className="relative bg-[#EEF5FF] flex flex-col justify-center items-center w-full h-auto  overflow-hidden ">
        <div className="static w-[85%] flex flex-col justify-center items-center 2xl:w-[1280px] px-[15px] pt-[70px] pb-[10px] at500:px-[40px]  md:px-[80px] my-0 mx-auto">
          ...
          <div className="flex flex-col-reverse lg:flex-row justify-center items-center  w-full h-auto lg:h-[561px]">
              ...
              <div className="relative flex justify-start items-start w-full h-auto text-left">
                ...
                <div className="flex flex-col justify-center items-start gap-[17.78px] text-left lg:w-[392px]">
                  ...
                  >
                    Our PartnerPlus Connect webinar is open to all travel industry stakeholders. However, to get the full experience
                    and enjoy access to our complete library or past episodes, you’ll need to sign up for our affiliate program, Trade PartnerPlus.
                  </p>
                  <p data-aos="fade-up" className=" text-[16px] leading-[24px] text-[#375370]">
                    You’ll also enjoy other benefits like access to our extensive network of suppliers, marketing support and resources, unbelievable
                    discounts, ticket issuance on GDS platforms,  and hardware and software assistance from our world-class global support centre
                  </p>
                </div>
