            ...
            <div className="static w-full flex flex-col justify-center items-center 2xl:w-[1280px] px-[15px] py-[30px] at500:px-[80px] my-0 mx-auto">
                <div className="flex flex-col lg:flex-row justify-center items-center gap-[70px] w-full">
                    ...
                    <h6 data-aos="fade-up" className="!font-semibold text-[#FFFFFF] text-center lg:w-[850px]">
                        We do this by hosting an industry-focused monthly webinar, PartnerPlus Connect, where some of our
                        top executives share industry insights, break down industry trends as they pertain to blooming agencies,
                        and share tips and trade secrets to help aspiring or blossoming agents or agencies grow and scale their businesses effectively.
                    </h6>
