      ...
      <div className="relative flex justify-center items-center w-full 2xl:w-[1280px] py-[20px] px-[15px] at500:px-[40px]">
        ...
        <div className="relative w-full mx-auto flex md:flex-row justify-between items-start md:items-center">
          ...
          <div className="flex gap-[30px] justify-center items-center silver:hidden cursor-pointer z-[999]">
            <div>
              {toggle ? (
                <AiOutlineClose onClick={closeMenu} size={20} className="text-[#05284C]" />
              ) : (
                <HiMenuAlt3 onClick={openMenu} size={30} className="text-[#05284C]" />
              )}
            </div>
            <div className="w-[65px]">
              <Button size="small" onClick={handleClick} className="hover:text-gray-400 bg-[#05284C] text-white">Login</Button>
            </div>
          </div>
        </div>
              ...
              >
                ...
                {hovered && (
                  ...
                  >
                    <ul className="flex flex-col py-2">
                      <li className='flex justify-center items-center w-full px-[5px]'>
                        <a href="#" className="flex w-full px-4 text-[#05284C] dark:hover:text-gray-600">Our story</a>
                      </li>
                    </ul>
                  </div>
                )}
